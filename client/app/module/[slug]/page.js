...
const Page = () => {
    ...
    "content": [
        {
            ...
            "link": "https://www.youtube.com/watch?v=example-java-setup-and-helloworld",
            "mcqs": [
                {
  ...
  return (
    <main className="flex overflow-auto flex-col items-center justify-center min-h-screen bg-zinc-900 text-white p-4">
      <div className="p-4">
        <h1 className="text-5xl font-bold mb-6 text-white/80 "  >{lesson.title}</h1>
        <NotesBlock notes={content.notes} />
        <LinkBlock link={content.link} />
...
const LinkBlock = ({ link }) => (
  link ? (
    <div className="p-4 rounded-lg shadow-md mb-4">
      <h2 className="text-xl font-semibold mb-2">Reference Video</h2>
      ...
      <ul className="list-disc pl-5">
        {mcqs.map((mcq, idx) => (
          <li key={idx} className="mb-3">
            ...
            <div className="mt-1 text-green-600">Answer: <span className="font-bold">{mcq.answer}</span></div>
          </li>
        ))}
      </ul>
    </div>
